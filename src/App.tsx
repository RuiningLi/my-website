...
const ExperienceGS = lazy(() => import('./pages/experiences/GS'));
const ExperiencePonyAI = lazy(() => import('./pages/experiences/PonyAI'));
const EducationOxford = lazy(() => import('./pages/education/Oxford'));
      ...
      <Suspense fallback={<div className={classes.skeleton} />}>
        <Routes>
          ...
          <Route path={EXPERIENCES}>
            ...
            <Route path={GS} element={<ExperienceGS />} />
            <Route path={PONYAI} element={<ExperiencePonyAI />} />
          </Route>

          <Route path={EDUCATION}>
            <Route path={OXFORD} element={<EducationOxford />} />
          </Route>
